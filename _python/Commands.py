...
def spin_change(mot, self):
    ...
    if Settings.LINKED:
        if not mot:
            ...
            if roundF(int(decimal.Decimal(str(self.frame_spinBox.value())) * 100)) in Settings.speed_dict:
            ...
            if roundF(int(decimal.Decimal(str(self.core_spinBox.value())) * 100)) in Settings.speed_dict:
